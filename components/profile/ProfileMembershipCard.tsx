...
export default function ProfileMembershipCard({ card }: Props) {
  ...
  return (
    <div className="bg-card border border-border rounded-2xl p-6 transition-all hover:shadow-md">
      ...
      {card ? (
        <div className="bg-gradient-to-br from-primary to-primary-dark rounded-xl p-5 text-white shadow-lg relative overflow-hidden">
          {/* Decorative elements */}
        ...
        <div className="text-center py-6">
          ...
          <p className="text-xs text-muted mt-1">Contactez l&apos;administration</p>
        </div>
      )}
    </div>
  );
